...
const Review = () => {
  return (
    <div className="bg-[#A5A8C1] py-10">
      <AppLayout>
        <h2 className="font-bold text-[30px]  text-center pb-6  text-[#72909E] ">
          Our Clients Says
        </h2>
        <div>
          {" "}
          ...
          >
            {Feedbackmock.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="mt-2 my-2 h-[210px] w-[350px] sm:w-[370px] lg:w-[380px] bg-[#353956] text-[#F1F1F1] rounded-xl mx-auto">
